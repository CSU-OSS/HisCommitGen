...
import json
from llm.cmg_model.model import CmgModel
from django.views.decorators.csrf import csrf_exempt
from typing import List
import logging
from llm.utils.utils import str_to_bool
...
def generate_commit_message(request):
    ...
    llm_result = blue_llm.get_commit_messages(diff, historyMessage, needRec)
    if len(llm_result['commit_messages']) > 0:
        llm_result = llm_result['commit_messages']
    rep_dict['commit_message'] = llm_result
